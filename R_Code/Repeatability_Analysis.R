...
plot(posterior(aovBF, iterations = 10000)[, "mu"])
plot(acf(posterior(aovBF, iterations = 10000)[, "mu"]))

# Chain appears relatively stable, although with some early peaks. No autocorrelation evident. Summarising

summary(aovBF)
summary(posterior(aovBF, iterations = 10000)[, "mu"])
...
# Results corroborate reasonably.
...
ggsave("/home/joshk/git_repositories/BCCH_IndVar/Figures/UR_Slopes_Chronic_OP.jpeg",
  UR_Plot,
  height = 5.67, width = 6.0, dpi = 800
)

ggsave("/home/joshk/git_repositories/BCCH_IndVar/Figures/UR_Slopes_Chronic_OP.pdf",
       UR_Plot,
       height = 5.67, width = 6.0, dpi = 800
)
...
plot(posterior(Acute_aovBF, iterations = 10000)[, "mu"])
plot(acf(posterior(Acute_aovBF, iterations = 10000)[, "mu"]))

# Chain is stable and peak looks clear. Note that trace is hovering surprisingly high. Summarising.

summary(Acute_aovBF)
summary(posterior(Acute_aovBF, iterations = 10000)[, "mu"])
...
ggsave("/home/joshk/git_repositories/BCCH_IndVar/Figures/UR_Slopes_Acute_New.jpeg",
  UR_Plot_Acute,
  height = 5.67, width = 6.0, dpi = 800
)

ggsave("/home/joshk/git_repositories/BCCH_IndVar/Figures/UR_Slopes_Acute_New.pdf",
       UR_Plot_Acute,
       height = 5.67, width = 6.0, dpi = 800
)
